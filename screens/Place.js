            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        FONTS.largeTitle}}>{selectedPlace?.name}</Text>
                        ...
                        >
                            <Text style={{marginRight:5, color:
                            COLORS.white, ...FONTS.h3}}>{selectedPlace?.rate}</Text>
                    ...
                    {/* Description */}
                        ...
                        <Text style={{marginTop:SIZES.base, color:
                        COLORS.white, ...FONTS.body3}}>{selectedPlace?.description}
                    ...
                    >
                        ...
                        >
                            {selectedPlace?.hotels.map((hotel, index)=>(
                                ...
                                >
                                    <Image
                                        source={selectedHotel?.id
                                        == hotel.id ? icons.bed_on
                                    : icons.bed_off }
                                        resizeMode="contain"
                                        style={{
                                            width:50,
                        ...
                        >
                            <Text style={{ color:COLORS.white, ...
                            FONTS.h1}}>Hotels in {selectedPlace?.name}</Text>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                       ...
                                       <View style={{
                                           ...
                                           <Text style={{
                                               color:COLORS.lightGray, ...FONTS
                                               .body5, fontSize:Platform.OS==='android'?
                                               SIZES.body4: SIZES.body5
